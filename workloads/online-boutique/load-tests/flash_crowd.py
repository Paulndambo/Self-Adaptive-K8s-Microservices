...
def main() -> None:
    parser = argparse.ArgumentParser(description="Run a flash-crowd Online Boutique workload.")
    ...
    summary = run_load_test(
        scenario="online_boutique_flash_crowd",
        base_url=args.base_url,
        steps=build_steps(args.duration_seconds, args.initial_users, args.peak_users, args.surge_after_seconds),
